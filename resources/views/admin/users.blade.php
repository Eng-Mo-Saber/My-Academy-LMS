                                ...
                                <tr>
                                    <td class="px-4">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <h6 class="mb-0 fw-bold small">مو صابر</h6>
                                                <small class="text-muted">mo@example.com</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-info-subtle text-info px-3">طالب</span></td>
                                    <td><small>2026/01/12</small></td>
                                    <td><span class="badge bg-success-subtle text-success">نشط</span></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-outline-primary" title="تعديل"><i class="bi bi-pencil"></i></button>
                                            <button class="btn btn-sm btn-outline-danger" title="حظر" onclick="confirmDelete()"><i class="bi bi-slash-circle"></i></button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="px-4">
                                        <div class="d-flex align-items-center">
                                            <div>
                                                <h6 class="mb-0 fw-bold small">أحمد محمد</h6>
                                                <small class="text-muted">ahmed@example.com</small>
                                            </div>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-primary-subtle text-primary px-3">محاضر</span></td>
                                    <td><small>2025/11/05</small></td>
                                    <td><span class="badge bg-success-subtle text-success">نشط</span></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-sm btn-outline-primary" title="تعديل"><i class="bi bi-pencil"></i></button>
                                            <button class="btn btn-sm btn-outline-danger" title="حظر"><i class="bi bi-slash-circle"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content border-0 shadow">
                ...
                <div class="modal-footer border-top-0">
                    ...
                    <button type="button" class="btn btn-primary" onclick="handleFormSubmit()">حفظ المستخدم</button>
                </div>
            </div>
        </div>
    </div>
